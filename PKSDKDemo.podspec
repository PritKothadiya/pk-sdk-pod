#
#  Be sure to run `pod spec lint PKSDK.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/PritKothadiya/pk-sdk-pod"
  ...
  spec.author             = { "Prit" => "pritkothadiya@gmail.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
